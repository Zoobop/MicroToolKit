...
int main()
{
	...
	mdt::List<Vector3> listVec100000;
	{
		TEST_PROFILER("Add");
		for (auto i = 0; i < 50000; i++)
	...
	mdt::List<Vector3> listVec1000000;
	{
		TEST_PROFILER("Add");
		for (auto i = 0; i < 500000; i++)
	...
	mdt::List<Player> listPlay100000;
	{
		TEST_PROFILER("Add");
		for (auto i = 0; i < 50000; i++)
	...
	mdt::List<Player> listPlay1000000;
	{
		TEST_PROFILER("Add");
		for (auto i = 0; i < 500000; i++)
